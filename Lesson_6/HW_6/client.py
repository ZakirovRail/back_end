...
def main():
    ...
    logger.debug(f'The connection with a server were established using server_address={server_address} and server_port={server_port}')
    ...
    try:
        ...
        logger.debug(f'The response from the server were received:  \n {response}')
...
if __name__ == '__main__':
    logger.debug(f'If name = Start running client with the main() method on the client side')
    main()
